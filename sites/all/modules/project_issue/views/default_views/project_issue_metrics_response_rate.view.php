...
/* Filter criterion: Response rate and time by project: value_response_rate */
$handler->display->display_options['filters']['value_response_rate']['id'] = 'value_response_rate';
$handler->display->display_options['filters']['value_response_rate']['table'] = 'sampler_project_issue_responses_by_project';
$handler->display->display_options['filters']['value_response_rate']['field'] = 'value_response_rate';
$handler->display->display_options['filters']['value_response_rate']['operator'] = 'not empty';
$translatables['project_issue_metrics_response_rate'] = array(
  t('Master'),
  t('Response rate'),
  t('more'),
  t('Apply'),
