...
/* Footer: Global: Project issue create child link */
$handler->display->display_options['footer']['project_issue_create_child']['id'] = 'project_issue_create_child';
$handler->display->display_options['footer']['project_issue_create_child']['table'] = 'views';
$handler->display->display_options['footer']['project_issue_create_child']['field'] = 'project_issue_create_child';
$handler->display->display_options['footer']['project_issue_create_child']['empty'] = TRUE;
$handler->display->display_options['defaults']['empty'] = FALSE;
/* No results behavior: Global: Text area */
$handler->display->display_options['empty']['area']['id'] = 'area';
$handler->display->display_options['empty']['area']['table'] = 'views';
$handler->display->display_options['empty']['area']['field'] = 'area';
$handler->display->display_options['empty']['area']['label'] = 'Show footer for no results';
...
$translatables['project_issue_issue_relations'] = array(
  t('Master'),
  t('Related issues'),
  t('more'),
  t('Apply'),
  ...
  t('Asc'),
  t('Desc'),
  t('Block: Referenced by'),
  t('Referenced by'),
  t('Content entity referenced from field_issue_related'),
  t('All'),
  t('Project issue: Referenced by'),
  t('Block: Child issues'),
  t('Child issues'),
  t('Show footer for no results'),
  t('Content entity referenced from field_issue_parent'),
  t('Project issue: Child issues'),
  t('Block: Parent issue'),
  t('Parent issue'),
  t('Project issue: Parent issue'),
  t('Block: Related issues'),
  t('Project issue: Related issues'),
);
