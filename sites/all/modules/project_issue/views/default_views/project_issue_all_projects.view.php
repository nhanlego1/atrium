...
$view->human_name = 'Project Issue All Projects';
$view->core = 0;
...
$handler->display->display_options['row_options']['creator_field'] = 'name_1';
...
$handler->display->display_options['fields']['title']['alter']['text'] = '[title_1]: [title]';
...
$translatables['project_issue_all_projects'] = array(
  t('Defaults'),
  ...
  t('next ›'),
  t('last »'),
  t('No issues match your criteria.'),
  t('Assigned user'),
  t('Project node'),
  t('Project'),
  t('Summary'),
