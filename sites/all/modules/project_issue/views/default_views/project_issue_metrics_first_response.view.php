...
$view = new view();
$view->name = 'project_issue_metrics_first_response';
$view->description = '';
$view->tag = 'Project issue';
$view->base_table = 'sampler_project_issue_responses_by_project';
$view->human_name = 'Project issue metric: 1st response';
$view->core = 7;
...
$handler->display->display_options['title'] = '1st response';
...
$handler->display->display_options['footer']['area_text_custom']['label'] = 'Units';
$handler->display->display_options['footer']['area_text_custom']['content'] = '<small>hours</small>';
...
/* Field: Response rate and time by project: value_response_time */
$handler->display->display_options['fields']['value_response_time']['id'] = 'value_response_time';
$handler->display->display_options['fields']['value_response_time']['table'] = 'sampler_project_issue_responses_by_project';
$handler->display->display_options['fields']['value_response_time']['field'] = 'value_response_time';
$handler->display->display_options['fields']['value_response_time']['separator'] = '';
...
$handler->display->display_options['fields']['expression']['expression'] = '[value_response_time]/60/60';
...
/* Filter criterion: Response rate and time by project: value_response_time */
$handler->display->display_options['filters']['value_response_time']['id'] = 'value_response_time';
$handler->display->display_options['filters']['value_response_time']['table'] = 'sampler_project_issue_responses_by_project';
$handler->display->display_options['filters']['value_response_time']['field'] = 'value_response_time';
$handler->display->display_options['filters']['value_response_time']['operator'] = 'not empty';
$translatables['project_issue_metrics_first_response'] = array(
  t('Master'),
  t('1st response'),
  t('more'),
  t('Apply'),
